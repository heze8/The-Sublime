...
namespace Dialogue
{
        ...
        /*private string FormatOutput(string dialogueInput, int indexOfError)
    {
        ...
        private void OnEnter()
        {
            ...
            {
                SpeakToNearbyNPC(); //handles NPC dialogue
                SpeakToDialogueParser(typeManager.GetCurrentDialogueInput());
                isSpeaking = false;
        ...
        private void SpeakToDialogueParser(string currentDialogueInput)
        {
            DialogueParser.Instance.ParseDialogue(currentDialogueInput);
        }

        void SpeakToNearbyNPC()
        {
